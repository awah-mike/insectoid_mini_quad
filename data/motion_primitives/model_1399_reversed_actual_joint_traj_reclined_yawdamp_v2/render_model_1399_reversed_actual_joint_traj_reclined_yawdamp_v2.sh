...
"${REPO_ROOT}/rl/scripts/render_reversed_joint_trajectory.py" \
  ...
  --output "${OUTPUT_DIR}/model_1399_reversed_actual_joint_traj_reclined_yawdamp_v2_side_iso.mp4" \
  --summary-output "${OUTPUT_DIR}/model_1399_reversed_actual_joint_traj_reclined_yawdamp_v2_side_iso.summary.json"
