...
/home/ubuntu/IsaacLab/isaaclab.sh -p rl/scripts/render_reversed_joint_trajectory.py --headless \
  ...
  --output /home/ubuntu/insectoid_mini_quad/outputs/renders/model_1399_forward_canonical_sideways_xpos_signpos_s25_front_iso.mp4 \
  --summary-output /home/ubuntu/insectoid_mini_quad/outputs/renders/model_1399_forward_canonical_sideways_xpos_signpos_s25_front_iso.summary.json \
  ...
  --root-body-vel-x-servo-target 0.35 --root-body-vel-x-servo-alpha 1.0 \
  --root-body-vel-y-servo-target 0.0 --root-body-vel-y-servo-alpha 1.0 \
  --sideways-remap-scale 1.5 --sideways-remap-sign 1.0 --sideways-remap-y-keep-scale 0.0 --sideways-remap-x-keep-scale 1.0 --sideways-remap-max-action-delta 0.85 \
  ...
  --camera-eye 0.9 -4.2 2.8 --camera-lookat 0.9 0.0 0.12
